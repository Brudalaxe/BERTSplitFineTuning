...
# path settings
parser.add_argument("--pretrain_dir", type=str, default="/home/brad/models/splitfinetuning/pretrain/bert-base-uncased")
parser.add_argument("--data_dir", type=str, default="/home/brad/models/splitfinetuning/data/SST-2")
